    ...
    <>
      <style>{`
        .imx-support-overlay {
          ...
          width: 100% !important;
          max-width: 480px !important; /* Constrain to mobile width on PC/Tablet */
        ...
        .imx-input-area {
          ...
          padding-bottom: env(safe-area-inset-bottom, 20px) !important; /* Safe area for mobile */
        }
        .imx-chat-input {
          background: #F3F4F6 !important;
          color: #111827 !important;
      ...
      <div className="imx-support-overlay">
        ...
        <div className="imx-header-bg" style={{ paddingTop: '16px', paddingBottom: '16px', paddingLeft: '16px', paddingRight: '16px', flexShrink: 0, display: 'flex', alignItems: 'center', gap: '12px' }}>
          <button onClick={onClose} style={{ width: '36px', height: '36px', borderRadius: '50%', background: '#F3F4F6', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        <div
          ...
          style={{ flex: 1, overflowY: 'auto', padding: '16px', display: 'flex', flexDirection: 'column', gap: '4px', position: 'relative' }}
        >
          {isLoading ? (
