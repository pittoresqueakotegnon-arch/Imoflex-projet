        ...
        <div className="listing-card-h">
          ...
          <div className="flex-1 p-3 flex flex-col justify-between min-w-0 relative">
            ...
            >
              <Heart
                size={18}
                className={isFavorite ? 'fill-red-500 text-red-500' : 'text-[var(--imx-text-muted)]'}
              />
            </button>

            <div className="pr-6">
              <h3 className="font-nunito font-800 text-[var(--imx-text-primary)] text-sm leading-tight line-clamp-2 mb-1">
                {listing.title}
              </h3>
  ...
  return (
    <Link to={`/annonce/${listing.id}`} className="block">
      <div className="card overflow-hidden" style={{ borderRadius: '20px' }}>
        {/* Image fixe 160px */}
        <div className="relative overflow-hidden bg-[var(--imx-surface-2)]" style={{ height: '160px' }}>
          {thumbUrl ? (
            <OptimizedImage src={thumbUrl} alt={listing.title} />
          ) : (
            <div className="w-full h-full flex items-center justify-center text-[var(--imx-text-muted)]">
        ...
        {/* Body */}
        <div className="p-3.5">
          <h3 className="font-nunito font-800 text-[var(--imx-text-primary)] text-sm leading-tight mb-1.5 line-clamp-2">
            {listing.title}
          </h3>
          <div className="flex items-center gap-1 text-[var(--imx-text-secondary)]">
            <MapPin size={12} />
