...
const ImageGalleryModal: React.FC<ImageGalleryModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[100] pointer-events-none flex justify-center bg-black/80 backdrop-blur-sm">
      <div className="w-full max-w-[390px] h-full bg-[var(--imx-bg-app)] text-[var(--imx-text-primary)] overflow-hidden flex flex-col pointer-events-auto relative shadow-[0_0_80px_rgba(123,63,228,0.2)]">
        {/* ── Header ────────────────────────────────────────────── */}
      <div className="flex items-center justify-between p-4 bg-[var(--imx-bg-app)] shadow-md z-10 relative">
                ...
                {photos.map((photo, idx) => (
                  <button
                    ...
                    className={`flex-shrink-0 w-12 h-12 rounded-lg overflow-hidden transition-all ${
                      idx === currentIndex
                        ? 'ring-2 ring-[var(--imx-accent-light)] ring-offset-2 ring-offset-black opacity-100 scale-110'
