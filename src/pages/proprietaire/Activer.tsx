    ...
    return (
      <div className="page-container">
        <div className="px-4 pt-6">
          <div className="h-40 bg-[var(--imx-surface)] rounded-3xl animate-pulse"></div>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-[var(--imx-bg-app)] text-[var(--imx-text-primary)] flex flex-col px-5 pt-12 pb-8">
      ...
      <button
        ...
        className="flex items-center gap-1.5 text-[var(--imx-accent-light)] text-sm mb-8 w-fit"
        ...
        <div className="space-y-6 flex-1 flex flex-col justify-between">
          <div className="space-y-5">
            ...
            <div className="card p-4">
              <p className="text-[var(--imx-text-secondary)] text-[10px] font-space-grotesk font-semibold uppercase tracking-wider mb-1">ANNONCE</p>
              <h3 className="font-nunito font-700 text-[var(--imx-text-primary)] text-base">{listing.title}</h3>
              <p className="text-xs text-[var(--imx-text-secondary)] mt-1" style={{ fontFamily: 'Space Grotesk' }}>{listing.city}</p>
            </div>

            {requesterInfo && (
              <div className="bg-[var(--imx-surface-2)] p-4 rounded-2xl border border-[var(--imx-accent-light)]/30">
                <p className="text-[var(--imx-accent-light)] text-[10px] font-space-grotesk font-semibold uppercase tracking-wider mb-1">POUR LE CANDIDAT</p>
                <p className="font-nunito font-700 text-[var(--imx-text-primary)] text-sm">{requesterInfo.name}</p>
                <p className="text-xs text-[var(--imx-text-secondary)] mt-1">{requesterInfo.phone}</p>
              </div>
            )}
        ...
        <div className="space-y-6 flex-1 flex flex-col justify-between">
          <div className="space-y-5">
            ...
            <div>
              ...
              <p className="text-[10px] text-[var(--imx-text-secondary)] mt-2 italic" style={{ fontFamily: 'Space Grotesk' }}>
