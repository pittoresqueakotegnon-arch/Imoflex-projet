            ...
            return (
              <div key={listing.id} className="card p-3.5 flex gap-3.5">
                ...
                <div className="flex-1 min-w-0 flex flex-col justify-between">
                  ...
                  <div className="flex items-end justify-between mt-2 pt-2 border-t border-[var(--imx-surface-2)]">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {listing.availability_status === 'disponible' && (listing as any).status === 'publiee' && (
                        <Link
                          ...
                          className="flex items-center gap-1 text-[10px] font-bold text-[var(--imx-accent-light)] hover:text-purple-300 transition-colors"
                        >
                          <Eye size={11} />
                          Voir les demandes
                        </Link>
