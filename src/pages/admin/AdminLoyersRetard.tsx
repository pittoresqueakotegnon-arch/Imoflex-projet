    ...
    <div className="p-6">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-[var(--imx-text-secondary)] text-sm mt-1" style={{ fontFamily: 'Space Grotesk' }}>
      ...
      {loading ? (
        ...
        <div className="card p-8 text-center border border-dashed border-[var(--imx-surface-2)] bg-transparent">
          <p className="text-[var(--imx-text-secondary)]">Aucun loyer en retard actuellement.</p>
        </div>
      ) : (
