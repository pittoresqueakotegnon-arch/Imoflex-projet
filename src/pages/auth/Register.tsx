    ...
    return (
      ...
      >
        ...
        <div
          ...
          style={{ background: 'var(--imx-surface-2)', border: '1px solid var(--imx-border)', boxShadow: 'var(--imx-card-shadow-sm)' }}
        >
        ...
        <p className="text-xs text-center mb-8 max-w-xs" style={{ fontFamily: 'Space Grotesk', color: 'var(--imx-text-muted)' }}>
        ...
        <div className="flex gap-1.5 sm:gap-2 mb-6 w-full max-w-sm justify-center items-center" onPaste={handleOtpPaste}>
          {otpDigits.map((digit, i) => (
            <React.Fragment key={i}>
              {i === 4 && <span className="text-[var(--imx-text-muted)] font-bold px-0.5">-</span>}
              <input
                ...
                autoFocus={i === 0}
                className="w-8 h-12 sm:w-10 sm:h-14 text-center text-lg sm:text-xl font-bold rounded-xl border-2 outline-none transition-all"
                style={{
                  background: 'var(--imx-surface-2)',
                  borderColor: digit ? 'var(--imx-accent)' : 'var(--imx-border)',
                  color: 'var(--imx-text-primary)',
                  fontFamily: 'Space Grotesk',
                  boxShadow: digit ? '0 0 10px rgba(var(--imx-accent-rgb, 16, 185, 129), 0.25)' : 'none',
                }}
              />
            </React.Fragment>
          ))}
