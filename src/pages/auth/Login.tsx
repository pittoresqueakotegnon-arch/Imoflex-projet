    ...
    >
      ...
      <div className="flex-1 flex flex-col px-5 pt-6 pb-safe" style={{ paddingBottom: 'max(32px, env(safe-area-inset-bottom))' }}>
        ...
        <div className="flex flex-col items-center mb-10" style={fadeStyle(0)}>
          ...
          <h1 className="text-3xl mb-1 text-center" style={{ fontFamily: 'Nunito', fontWeight: 900, color: '#E8E0FF' }}>
            Bon retour 👋
          </h1>
          <p className="text-sm text-center" style={{ fontFamily: 'Space Grotesk', color: '#8B7BB5' }}>
          ...
          <div className="flex items-center justify-between px-1">
            <label className="flex items-center gap-2 cursor-pointer" onClick={() => setRememberMe(!rememberMe)}>
              <div
                ...
                style={{
                  background: rememberMe ? '#7B3FE4' : 'transparent',
                  border: `1.5px solid ${rememberMe ? '#7B3FE4' : 'rgba(255,255,255,0.15)'}`,
                }}
              >
                {rememberMe && <Check size={12} className="text-white" />}
              </div>
              <span className="text-xs" style={{ fontFamily: 'Space Grotesk', color: '#8B7BB5' }}>
                Se souvenir de moi
              </span>
            </label>
            <Link
              ...
              style={{ fontFamily: 'Space Grotesk', color: '#A855F7' }}
            >
              Mot de passe oublié ?
            </Link>
          </div>
