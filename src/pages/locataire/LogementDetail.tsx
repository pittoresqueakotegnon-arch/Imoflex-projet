      ...
      {currentPeriod ? (
        <>
          <div
            ...
            style={{ background: 'linear-gradient(135deg, #2D1B69 0%, #170E3D 100%)', border: isLate ? '1px solid rgba(239,68,68,0.4)' : '1px solid var(--imx-border)' }}
          >
            <div
            ...
            <p className="text-[var(--imx-text-secondary)] text-[10px] font-space-grotesk font-bold uppercase tracking-wider mb-4 relative z-10">
              Loyer — {getMonthName(now.getMonth() + 1, now.getFullYear())}
            </p>

            <div className="mb-5 relative z-10">
              <p className="font-nunito font-black text-[2.2rem] leading-none">
                {paid.toLocaleString('fr-FR')} <span className="text-[1.3rem] font-normal text-[var(--imx-text-secondary)]">FCFA</span>
              </p>
              <p className="text-[var(--imx-text-secondary)] text-xs mt-1" style={{ fontFamily: 'Space Grotesk' }}>
            ...
            <div className="mb-4 relative z-10">
              <div className="h-1.5 rounded-full w-full" style={{ background: 'rgba(255,255,255,0.15)' }}>
                <div className="h-full rounded-full" style={{ width: `${percentage}%`, background: isLate ? '#EF4444' : 'var(--imx-accent-light)' }} />
              </div>
              <div className="flex justify-between mt-2 text-[10px] font-bold" style={{ fontFamily: 'Space Grotesk' }}>
                <span style={{ color: isLate ? '#EF4444' : 'var(--imx-accent-light)' }}>{Math.round(percentage)}% payé</span>
                <span className="text-[var(--imx-text-secondary)]">{Math.round(100 - percentage)}% restant</span>
              </div>
            </div>
