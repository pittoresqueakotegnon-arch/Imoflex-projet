-- 1. Création de la table financial_ledger
...
-- 2. Machine d'état stricte pour la table payments
...
-- 3. Mise à jour de process_payment_webhook pour y inclure le Ledger
...
-- 4. Modification de l'intervalle du cron de 10 min à 5 min
